...
import { WaveSurfer, WaveSurfer_setApp } from "./dist/wavesurfer.js";
import { WaveSurfer_regions_setApp } from "./dist/plugin/wavesurfer.regions.js";
import { AudioUtils as _AudioUtils } from "./actions.js";
import { OneUp } from "./oneup.js";
import { PKSimpleModal } from "./modal.js";
import { ID3v2 } from "./id3.js";

const w = window;
const d = document;

export function PKEng ( app ) {
	var q = this;
	const PKAudioEditor = app;
	WaveSurfer_setApp(app);
	WaveSurfer_regions_setApp(app);
	...
	wavesurfer.container = d.getElementById('#' + 'pk_av_' + app.id);
	console.log("container", wavesurfer.containe)

	// Initialize the Regions plugin
	const wsRegions = wavesurfer.registerPlugin(RegionsPlugin.create())
	WaveSurfer.regions = {
		create: opt => wsRegions.addRegion(opt),
	};
	*/

	this.wavesurfer = wavesurfer;

	var AudioUtils = new _AudioUtils( app, wavesurfer );
	q.is_ready = false;
